...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   handling_placeholder.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: pgenesis <marvin@42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/07/26 18:00:40 by pgenesis          #+#    #+#             */
/*   Updated: 2020/07/26 18:10:15 by pgenesis         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		get_place_holder_position(t_head *stacks, int current_chunk)
{
	...
	define_place_holders(place_holder_bottom,
						place_holder_top, stacks, current_chunk);
